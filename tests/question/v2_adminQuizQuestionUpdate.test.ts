...
describe('adminQuizQuestionUpdate', () => {
  ...
  test('Question Id does not refer to a valid question within this quiz', () => {
    const req = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId}/question/${questionId + 1}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
          question: 'Who is the Monarch of England?',
  ...
  test(`Question string is less than 5 characters in length or greater than 50 
    characters in length - less than 5`, () => {
    const req = request('PUT', SERVER_URL +
  ...
  test(`Question string is less than 5 characters in length or greater than 50 characters in length
     - greater than 50`, () => {
    const req = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId}/question/${questionId}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
  ...
  test(`Valid session is provided, but user is not an owner 
    ...
    const req = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId + 1}/question/${questionId}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
          question: 'Who is the Monarch of England?',
  ...
  test(`Valid session is provided, but user is not an owner of 
    ...
    const req = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId2}/question/${questionId}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
          question: 'Who is the Monarch of England?',
  ...
  test('Valid - one user, two questions updated', () => {
    ...
    const req2 = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId2}/question/${questionId2}`, {
      headers: { session: userSession.toString() },
      json: {
  ...
  test('Valid - one quiz, two questions', () => {
    ...
    const req2 = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId}/question/${questionId2}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
          question: 'Who is the Monarch of England?2',
  ...
  test(`The thumbnailUrl does not end with one of the 
  ...
  test(`Thumbnail url doesnt start with http:// or https:// 
        AND does not end with jpg, jpeg, png`, () => {
    const req = request('PUT', SERVER_URL + `/v2/admin/quiz/${quizId}/question/${questionId}`, {
      headers: { session: userSession.toString() },
      json: {
        questionBody: {
